...
export  function FellowshipHeroes() {
  const fellowshipHeroes = [
    {
      name: "Gendalf",
      age: 2000,
    ...
    },
    {
      ...
      isDark: true,
      image:
        "https://static.wikia.nocookie.net/pjmidearthfilms/images/4/48/Curunir3.jpg",
    },
    {
      name: "Frodo",
      age: 35,
...
return(
  fellowshipHeroes.map((hero, index) => (
    <Fellowship
    key={index}
    name={hero.name}
    age={hero.age}
